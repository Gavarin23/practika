        ...
        return (
            <div className={styles.sideBar}>
                <div className={styles.sideBar__header}>
                    <div className={styles.sideBar__header__text}>Критерии</div>
                    <div
                ...
                <div className={styles.sideBar__area}>
                    <div className={styles.sideBar__area__text}>Заработная плата</div>
                ...
                <div className={styles.sideBar__area}>
                    <div className={styles.sideBar__area__text}></div>
                    <Select
                        style={selectStyle}
                        className="reactDropdownSelect"
                ...
                <div className={styles.sideBar__area}>
                    <div className={styles.sideBar__area__text}>Опыт </div>
                    <Select
                        style={selectStyle}
                        className="reactDropdownSelect"
                        placeholder="Не важно"
                ...
                <div className={styles.sideBar__area}>
                    <div className={styles.sideBar__area__text}>Род деятельности </div>
                    <Select
                        style={selectStyle}
                        className="reactDropdownSelect"
                        placeholder="Не важно"
                ...
                <div className={styles.sideBar__area}>
                    <div className={styles.sideBar__area__text}>График </div>
                    <Select
                        style={selectStyle}
                        className="reactDropdownSelect"
